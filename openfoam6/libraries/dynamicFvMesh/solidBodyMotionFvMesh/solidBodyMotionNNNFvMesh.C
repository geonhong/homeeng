...
#include "solidBodyMotionNNNFvMesh.H"
...
namespace Foam
{
    defineTypeNameAndDebug(solidBodyMotionNNNFvMesh, 0);
    addToRunTimeSelectionTable(dynamicFvMesh, solidBodyMotionNNNFvMesh, IOobject);
}


// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

Foam::solidBodyMotionNNNFvMesh::solidBodyMotionNNNFvMesh(const IOobject& io)
:
    dynamicFvMesh(io),
    dynamicMeshCoeffs_
    (
    ...
    SBMFPtr_(solidBodyMotionNNNFunction::New(dynamicMeshCoeffs_, io.time())),
    undisplacedPoints_
    (
        IOobject
        (
...
Foam::solidBodyMotionNNNFvMesh::~solidBodyMotionNNNFvMesh()
{}


// * * * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * //

bool Foam::solidBodyMotionNNNFvMesh::update()
{
